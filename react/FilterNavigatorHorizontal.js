...
HorizontalFilterNavigator.propTypes = {
  /** Categories tree */
  ...
  OrderBy: PropTypes.elementType,
  ...hiddenFacetsSchema,
}

export default withSearchPageContextProps(HorizontalFilterNavigator)
